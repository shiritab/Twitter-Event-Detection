...
def mainFunc():
    ...
    # subfolders = [f.path for f in os.scandir(folder) if f.is_dir()]
        ...
        to_ret_events = []
        for subwindow_name in subwindow_files[first_index:first_index+6]: # read timewindow consisting 6 subwindows of 1 hour each
        ...
        for e, event_worthiness in events:
            ...
            f = open(event_output_dir_text +"tagged_tweets_res"+ '.txt', 'w', encoding="utf-8")
        ...
        with open(event_output_dir_json+"/"+"tagged_tweets_res.json", 'w') as f:
